...
export default {
  data () {
    return {
      ...
      skills: {
        ...
        python: 'В языке Python я начал разбираться недавно. Мне интересны его возможности и гибкость. Хотелось бы улучшить свои навыки работы с этим языком',
        ...
        bitrix: 'Мне довелось работать с 1С Битрикс при первом трудоустройстве в качестве программиста. Это было не легко и данная система, честно говоря, мне не по душе. Уже мало что помню. По возможности, не хотелось бы работать с ней',
        javascript: 'С языка Javascript я начал заниматься веб-программированием. Однако, быстро перешёл на фреймворк JQuery и использовать нативный JS мне приходилось не часто. Я бы хотел улучшить свои навыки в работе с этим языком',
        jquery: 'Очень простой и понятный фреймворк. В нём я чувствую себя уверено и могу решать различные задачи без затруднений. Но, кажется, ему на смену уже пришли более современные фреймворки и придётся от него отказываться',
        ...
        design: 'До программирование и параллельно с ним я занимался веб-дизайном, рисовал, анимировал, 3D-графику. Поэтому, я довольно комфортно себя чувствую с такими инструментами как Photoshop, Illustrator и их аналоги',
  ...
  methods: {
    onSubmit () {
      ...
      this.axios.post('http://ivanopol.ru', data, options)
        .then(response => {
