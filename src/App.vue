...
export default {
  data () {
    return {
      ...
      skills: {
        php: 'На данный момент в языке PHP я чувствую себя уверенно, могу решать задачи различной сложности. Собираюсь и дальше в нём разбираться',
        ...
        modx: 'Я много работал с MODx, чувствую себя в нём уверенно и могу решать многие задачи. Однако, эта CMS развивается недостаточно интенсивно и, по возможности, я бы не хотел работать с ним больше',
        laravel: 'Мне нравится Laravel. На данный момент у меня мало практических навыков работы с ним. Я читал много статей, документацию, проходил курсы Дмитрий Елисеева по Laravel. В дальнейшем собираюсь работать с этим фреймворком или его аналогами',
        yii: 'С фреймворком Yii мне довелось поработать около года. В то время он мне очень нравился, но на данный момент я считаю, что этот фреймворк уходит в прошлое и стоит сосредоточиться на работе с Laravel. По возможности, я бы не хотел работать с данным фреймворком в будущем',
        ...
        bitrix: 'Мне довелось работать с 1С Битрикс при первом трудоустройстве в качестве программиста. Это было не легко и данная система, честно говоря, мне не по душе. Уже мало чего помню. По возможности, не хотелось бы работать с ней',
        javascript: 'С языка Javascript я начал заниматься программированием. Однако, быстро перешёл на фреймворк JQuery и использовать нативный JS мне приходилось не часто. Я бы хотел улучшить свои навыки в работе с этим языком',
